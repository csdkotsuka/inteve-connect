          ...
          <div className="space-y-2.5">
            ...
            <div className="grid grid-cols-4 gap-2 sm:gap-3">
              ...
              <button
                ...
                className={`p-2.5 sm:p-3.5 md:p-4 rounded-xl sm:rounded-2xl border flex flex-col items-center justify-center gap-1.5 sm:gap-2 transition-all text-[11px] sm:text-xs md:text-sm font-bold cursor-pointer active:scale-95 shadow-xs ${
                  authMethod === 'line'
              ...
              <button
                ...
                className="p-2.5 sm:p-3.5 md:p-4 rounded-xl sm:rounded-2xl border border-slate-200 hover:border-black bg-white hover:bg-slate-50 flex flex-col items-center justify-center gap-1.5 sm:gap-2 transition-all text-[11px] sm:text-xs md:text-sm font-bold cursor-pointer active:scale-95 shadow-xs"
              >
                <svg className="w-5 h-5 sm:w-6 sm:h-6 fill-current text-slate-900" viewBox="0 0 24 24">
              ...
              <button
                ...
                className="p-2.5 sm:p-3.5 md:p-4 rounded-xl sm:rounded-2xl border border-slate-200 hover:border-blue-500 bg-white hover:bg-blue-50/40 flex flex-col items-center justify-center gap-1.5 sm:gap-2 transition-all text-[11px] sm:text-xs md:text-sm font-bold cursor-pointer active:scale-95 shadow-xs"
              >
